...
void parallel_recursive_solve(Board &partial_board, int col,
...
void parallel_recursive_solve(Board &partial_board, int col,
                              tbb::concurrent_queue<Board> &sol) {
  // std::cout << "rec solve col " << col << std::endl;
  // pretty_print(b_partial);
...
void parallel_recursive_solve_count(Board &partial_board, int col,

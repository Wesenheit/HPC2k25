...
omp_set_num_threads(1);
  ...
  DataSet dataset_size = file.createDataSet(DatasetName_size, PredType::NATIVE_INT, dataspacesize);
  DataSet dataset_1 = file.createDataSet(DatasetName_1, PredType::NATIVE_FLOAT, dataspace1);
  DataSet dataset_2 = file.createDataSet(DatasetName_2, PredType::NATIVE_FLOAT, dataspace2);
  DataSet dataset_target = file.createDataSet(DatasetName_target, PredType::NATIVE_FLOAT, dataspacetarget);
